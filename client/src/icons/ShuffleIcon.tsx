  ...
  return (
    ...
    >
      <g>
        <g>
          <path
            d="M194.5,324.35l15-24.2c3.6-5.8,1.8-13.3-4-16.9c-5.7-3.6-13.3-1.8-16.9,4l-15,24.2c-27.2,43.9-66,69.1-106.6,69.1H12.2
			c-6.8,0-12.2,5.5-12.2,12.3s5.5,12.3,12.2,12.3h54.9C116.4,404.95,162.8,375.55,194.5,324.35z"
          />
          <path
            d="M486.4,88.75L427,29.25c-4.8-4.8-12.5-4.8-17.3,0s-4.8,12.5,0,17.3l38.6,38.6c-0.1,0-0.1,0-0.2,0h-56.7
          ...
          />
          <path
            d="M409.6,460.85c2.4,2.4,5.5,3.6,8.7,3.6s6.3-1.2,8.7-3.6l59.5-59.5c4.8-4.8,4.8-12.5,0-17.3l-59.5-59.4
